/*
  This Program is for demonstration of MORSE CODE Decryption 
...
Serial.println("************************************************************* ");
Serial.println("\nInstructions");
Serial.println("Please Write Your Morse code");
Serial.println("Press 1 on the above input box and then Press Enter ");
Serial.println("For Space between letters Press 2 and Press Enter ");
Serial.println("For Space between words Press 3 and Press Enter ");
Serial.println(" The Translation of Morse Code  will then be Shown ");
...
while(Serial.available() > 0 ) 
{
      ...
      switch(ascii)
      {
        ...
        Serial.print("\n");
        morseCode.concat('#');// Placing # at the end of morseCode to simplify further processing
